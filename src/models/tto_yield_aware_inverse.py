...
THE TOLERANCE-MODEL SUBSYSTEM
  every yield number is conditional on: a
...
USAGE
  ...
  #worst-case yield search :
  python3 tto_yield_aware_inverse.py --samples 0 --mode worstcase --fit-gate 1.0
...
OUT_DIR = PROJECT_ROOT / "results" / "models" / "evaluation_results" / "yield_aware_inverse_design"
