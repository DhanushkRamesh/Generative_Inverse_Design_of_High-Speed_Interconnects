...
if __name__ == "__main__":
    ...
    for dtype in ['array', 'link']:
        checkpoint_path = os.path.join(PROJ_ROOT, f"results/checkpoints/best_rational_net_fixedpole_{dtype}.pth")
        history_path = os.path.join(PROJ_ROOT, f"results/checkpoints/training_history_fixedpole_{dtype}.json")
