...
def _get_git_hash() -> str:
    ...
    try:
        return subprocess.check_output(
            ...
            stderr=subprocess.DEVNULL, cwd=_SRC_ROOT,
        ).decode().strip()
    except Exception:
        return "unknown"
...
# ---------------------------------------------------------------------------   
# csv loader, touchstone finder, log10 transform, z-score normalisation
# ---------------------------------------------------------------------------
...
def parse_dataset(
    ...
    print(f"{'=' * 70}\n")
    # Load the parameter CSV and optionally limit to first N sims (for testing).
