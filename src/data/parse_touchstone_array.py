# src/data/parse_touchstone_array.py
import os
import glob
import numpy as np 
import pandas as pd
...
def parse_touchstone_array(base_dir, output_dir):
    ...
    for idx, sim_id in tqdm(enumerate(sim_ids), total=len(sim_ids)):
        ...
        try:
            ...
            #append num_ports dynamically to the feature set for the inverse design model to learn array density variance.
...
if __name__ == "__main__":
    base_dir = os.path.expanduser("~/mece_project_inverse_model/Generative_Inverse_Design_of_High-Speed_Interconnects/data/raw/Universal-Diff-SI-Array")
    output_dir = os.path.expanduser("~/mece_project_inverse_model/Generative_Inverse_Design_of_High-Speed_Interconnects/data/processed/Universal-Diff-SI-Array")
    parse_touchstone_array(base_dir, output_dir)