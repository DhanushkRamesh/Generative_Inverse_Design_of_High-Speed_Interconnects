...
EDA_OUT_DIR = PROJECT_ROOT / "results" / "data" / "frequency_eda" / "array"
...
# Load frequency grid and (optionally) the existing single-weight scheme
print("\n=== Section 1: Load frequency grid ===")

# only need the frequency axis from the dataset; the per-element weight
...
# Mixed-mode 4x4 element convention
...
# Build per-element weight vectors w_type(f)
...
# Build the (4, 4, F) per-element tensor
...
# Per-band stats summary tied to the new weights
