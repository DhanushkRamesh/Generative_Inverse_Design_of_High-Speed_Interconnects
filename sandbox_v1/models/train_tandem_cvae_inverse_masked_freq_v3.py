"""
tandem_cvae_inverse_element_aware.py
--------------------------------------------------
...
def main():
    ...
    run_dir = RUNS_DIR / datetime.now().strftime(f"run_%Y-%m-%d_%H%M%S_inverse_element_aware_{args.dataset.lower()}")
    ...
    for epoch in range(1, args.epochs + 1):
        stats = train_inverse_epoch_element_aware(cvae, forward_model, train_loader, freqs_hz, w_bcast, device, optimizer)
