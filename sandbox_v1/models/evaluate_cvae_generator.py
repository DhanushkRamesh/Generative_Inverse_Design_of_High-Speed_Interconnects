...
EVAL_DIR = PROJECT_ROOT / "sandbox_v1" / "models" / "evaluation_results"
...
# ALREADY UPDATED: Your converged Epoch 80 cVAE Model
CVAE_MODEL_PATH = "/home/dhanushkramesh/mece_project_inverse_model/Generative_Inverse_Design_of_High-Speed_Interconnects/sandbox_v1/models/inverse_runs/run_2026-06-03_151050_inverse_cvae_array/cvae_checkpoint_ep80.pt"
...
def evaluate_and_plot():
    ...
    fig.suptitle("Generative Inverse Design: Target S-Parameters vs AI-Invented Hardware Validations", fontsize=16)
    ...
    save_path = EVAL_DIR / "final_inverse_validations.png"
